...
# =============================================================================
# STEP_08_L2_plot.R  (path-agnostic; was local_PCA_MDS_z/STEP_ZO_K_plot_L2.R)
#
# Multi-page L1+L2 overlay PDF for one chromosome.
#
# Facultative: short-circuits early when MAKE_L2_PLOTS is not truthy
# (accepts true|1|yes|y|on, case-insensitive; default = true). Set
# MAKE_L2_PLOTS=false in 00_inversion_config.sh to skip L2 plotting
...
.MAKE_L2_PLOTS <- Sys.getenv("MAKE_L2_PLOTS", "true")
if (!.is_true(.MAKE_L2_PLOTS)) {
  message("[STEP_08_L2_plot] MAKE_L2_PLOTS='", .MAKE_L2_PLOTS,
          "' is not truthy — skipping L2 plot stage.")
